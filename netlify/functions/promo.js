...
exports.handler = async () => {
  ...
  return {
    ...
    body: `<p style="text-align: center; margin: 0; line-height: 35px; font-size: 26px;color: #3d5567;" class="promo">Use code <b>${codeUS}</b> at checkout for 20% off sitewide - $500 CAD minimum for free shipping in Canada.</p>`
  };
};
